...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "centurion is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "centurion is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "centurion is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "centurion is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    result.push_back(Pair("coinbasesuffix", cbSuffix));
