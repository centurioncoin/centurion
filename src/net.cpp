...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "centurion " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"162.243.164.133", "138.68.154.87"},
    {"139.59.228.53", "node1.centurion.org"},
    {"node1.centurionlab.org", "node1.centurionlab.org"},
    {"node2.centurionlab.org", "node2.centurionlab.org"},
    {"node3.centurionlab.org", "node3.centurionlab.org"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("centurion-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("centurion-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("centurion-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("centurion-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. centurion is probably already running."), addrBind.ToString().c_str());
        else
