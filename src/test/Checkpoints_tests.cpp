//Our "mapCheckpoints" has 1 checkpoint(GenesisBlock) and this check no longer relevant
#if 0
...
BOOST_AUTO_TEST_CASE(sanity)
{
    ...
    BOOST_CHECK(Checkpoints::CheckHardened(14542, p11111));
    BOOST_CHECK(Checkpoints::CheckHardened(134444, p134444));


    // Wrong hashes at checkpoints should fail:
    BOOST_CHECK(!Checkpoints::CheckHardened(14542, p134444));
    BOOST_CHECK(!Checkpoints::CheckHardened(134444, p11111));

    // ... but any hash not at a checkpoint should succeed:
    BOOST_CHECK(Checkpoints::CheckHardened(14542+1, p134444));
